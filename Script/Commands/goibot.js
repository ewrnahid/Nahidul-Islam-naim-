...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "i love you bot")) {
     return api.sendMessage("আমাকে না আমার বস নাইম কে ভালোবাসো😻🥀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "kiss") || (event.body.toLowerCase() == "ummmah")) {
